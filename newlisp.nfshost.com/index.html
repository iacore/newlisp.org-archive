...
<br>
<h5> Stable Release version 10.7.5 - <a href="index.cgi?page=Downloads">May 12th, 2019</a>  </h5>
<h2> newLISP<small>&#174;</small> for macOS , GNU Linux, Unix and Windows </h2>
newLISP is a Lisp-like, general-purpose scripting language. It is especially well-suited for applications in AI, simulation, natural language processing, big data, machine learning and statistics. Because of its small resource requirements, newLISP is excellent for embedded systems applications. Most of the functions you will ever need are already built in. This includes networking functions, support for distributed and multicore processing, and Bayesian statistics.<br>
<br>
Read more about the <a href="index.cgi?FAQ">new LISP</a>
<br>
Find out how newLISP  <a href="index.cgi?page=Differences_to_Other_LISPs">differs from other LISPs</a>
<br>
Watch the <a href="http://nuevatec.nfshost.com/manual-intro.mov">Movie</a>  or <a href="http://nuevatec.nfshost.com/manual-intro.html">Slideshow</a>
<br>
Try <a href="newlisp-js/">newLISP in a Browser</a>  (best on Firefox)<br>
<br>
<ul><br>
<li> <a href="index.cgi?Documentation">Documented</a>, modern, complete <a href="downloads/manual_frame.html">API</a> </li>
<li> Expandable with <a href="modules/">modules</a>  and shared <a href="index.cgi?Libraries">C-libraries</a> </li>
<li> Server modes for distributed computing built-in</li>
<li> Parallel and distributed processing support built-in</li>
<li> Runs on macOS, Windows, Linux and other Unix.</li>
<li> Support for many <a href="index.cgi?Code_Contributions">Editors</a>.</li>
<li> GNU General Public License <a href="http://www.gnu.org/copyleft/gpl.html#SEC1">GPL</a>  <a href="http://www.gnu.org/copyleft/copyleft.html"><img src="copyleft.png" alt="copyleft" order="0" border="0"/></a> </li>
<li> See the big list of <a href="index.cgi?Features">features</a> </li>
<li> Follow <a href="http://twitter.com/newlisp">Twitter</a>  for newLISP.</li>
</ul> <form name="searchform" action="index.cgi" method="post">
    <input type="text" name="search" class="textarea" size="20" value=""/><input type="submit" name="submit" class="button" value="search"/></form>
<br>


<!-- AddTo This Button BEGIN, this is the Share button fot facebook, twitter etc -->
<div class="addthis_toolbox addthis_default_style">
<a href="http://www.addthis.com/bookmark.php?v=250&amp;username=xa-4c9a0bc41ae9d39d" class="addthis_button_compact">Share</a>
</div>
<script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js#username=xa-4c9a0bc41ae9d39d"></script>
<!-- AddThis Button END -->
